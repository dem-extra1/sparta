...
| `shoot.ogg`    | Kenney RPG Audio (unversioned) | `Audio/knifeSlice.ogg`                   | 0.60 s   | CC0 1.0 |
...
| `victory.ogg`  | Kenney Music Jingles (unversioned) | `Audio/Steel jingles/jingles_STEEL00.ogg` | 0.93 s | CC0 1.0 |
| `defeat.ogg`   | Kenney Music Jingles (unversioned) | `Audio/Hit jingles/jingles_HIT00.ogg` | 0.28 s | CC0 1.0 |

Impact Sounds and Interface Sounds carry a `1.0` version in their bundled
`License.txt`; RPG Audio and Music Jingles ship no version string (their
`License.txt` and Kenney pack page are unversioned), so the exact pack revision
is pinned instead by the dated download URLs below.

## Source packs

Pack landing pages (and the exact dated download URLs used, which pin the precise
pack revision regardless of version label):

- **Interface Sounds** (1.0) — <https://kenney.nl/assets/interface-sounds>
  (`kenney.nl/media/pages/assets/interface-sounds/fa43c1dd4d-1677589452/kenney_interface-sounds.zip`)
- **Impact Sounds** (1.0) — <https://kenney.nl/assets/impact-sounds>
  (`kenney.nl/media/pages/assets/impact-sounds/87b4ddecda-1677589768/kenney_impact-sounds.zip`)
- **RPG Audio** (unversioned) — <https://kenney.nl/assets/rpg-audio>
  (`kenney.nl/media/pages/assets/rpg-audio/8e99002d76-1677590336/kenney_rpg-audio.zip`)
- **Music Jingles** (unversioned) — <https://kenney.nl/assets/music-jingles>
  (`kenney.nl/media/pages/assets/music-jingles/f37e530b9e-1677590399/kenney_music-jingles.zip`)
