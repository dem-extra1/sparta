...
# Per-soldier prone timer (phase 5 / #201 slice B), index-aligned with _sim_soldier_pos:
# seconds-to-rise remaining (0 = standing). A knockback impulse can fell a soldier
# (SoldierCombat.prone_chance); a prone soldier loses active defence and can't strike until
# the timer decays to 0 (SoldierBodies.step decrements it). Seeded to 0 (everyone standing).
